...
public class LicenseDAOImpl implements LicenseDAO {
	...
	public LicenseDAOImpl() {// you can do it same but need of using constructor is that it improves readablility and instance variable has to be initialised through constructor 
